...
public class PasswordEncryption {
    ...
    public static final  int LOGIN_HASH_BIT_SIZE = 32 * 4;
    ...
    public static String getLoginPassword(String password, String salt) throws NoSuchAlgorithmException,
            InvalidKeySpecException {

        KeySpec spec = new PBEKeySpec(password.toCharArray(), salt.getBytes(), PBKDF2_ITERATIONS, LOGIN_HASH_BIT_SIZE);
        SecretKeyFactory f = SecretKeyFactory.getInstance(PBKDF2_ALGORITHM);
        return toHex(f.generateSecret(spec).getEncoded());
    }
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(PasswordEncryption.getLoginPassword("123456", "CunXinWa"));
    }
}  